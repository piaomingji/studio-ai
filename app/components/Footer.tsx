            ...
            <div className="flex-1 overflow-y-auto p-5 sm:p-6 text-xs text-slate-500 space-y-4 leading-relaxed scrollbar-thin">
              {modalType === 'terms' ? (
                ...
                <>
                  ...
                  <p>プライバシー保護の観点から、アップロードされた一時画像および生成された完成イメージは、生成処理が終了した時点で当サービスのサーバー上から即座に自動破棄され、保存・蓄積されることはありません（データ保存期間：0秒）。</p>

                  <p className="font-bold text-slate-800">4. 第三者への開示・提供の制限</p>
