...
export const PRINT_SIZES: PrintSize[] = [
  { id: "banmyeongham", label: "履歴書用 (3×4cm)", widthCm: 3, heightCm: 4, note: "履歴書・各種申請・免許証用" },
  { id: "jeungmyeong", label: "パスポート用 (3.5×4.5cm)", widthCm: 3.5, heightCm: 4.5, note: "パスポート・マイナンバー用" },
  { id: "myeongham", label: "大型証明写真 (5×7cm)", widthCm: 5, heightCm: 7, note: "大型各種申請・試験用" },
];
  ...
  return new Promise((resolve, reject) => {
    ...
    img.onload = () => {
      try {
        ...
        if (!ctx) throw new Error("キャンバスコンテキストを生成できません。");
